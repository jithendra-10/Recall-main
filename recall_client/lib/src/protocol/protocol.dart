...
import 'package:recall_client/src/protocol/notification.dart' as _i17;
import 'package:recall_client/src/protocol/chat_session.dart' as _i18;
import 'package:recall_client/src/protocol/chat_message.dart' as _i19;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i18.ChatSession>) {
      return (data as List)
              .map((e) => deserialize<_i18.ChatSession>(e))
              .toList()
          as T;
    }
