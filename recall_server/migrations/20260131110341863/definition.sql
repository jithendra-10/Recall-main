...
--
-- Class AgendaItem as table recall_agenda_item
--
CREATE TABLE "recall_agenda_item" (
    "id" bigserial PRIMARY KEY,
    "ownerId" bigint NOT NULL,
    "linkedContactId" bigint,
...
--
-- Class ChatMessage as table recall_chat_message
--
...
--
-- Class ChatSession as table recall_chat_session
--
...
--
-- Class Notification as table recall_notification
--
...
--
-- Class Task as table recall_task
--
...
--
-- Foreign relations for "recall_agenda_item" table
--
ALTER TABLE ONLY "recall_agenda_item"
    ADD CONSTRAINT "recall_agenda_item_fk_0"
    FOREIGN KEY("linkedContactId")
    REFERENCES "recall_contact"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;

--
-- Foreign relations for "recall_chat_message" table
--
...
--
-- Foreign relations for "recall_notification" table
--
...
--
-- Foreign relations for "recall_task" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('recall', '20260131110341863', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260131110341863', "timestamp" = now();
